...
public class BlePlatformService : IPlatformService
{
    protected readonly ILogger<BlePlatformService> _logger;

    public BlePlatformService(
        ILogger<BlePlatformService> logger)
    {
        _logger = logger;
    }
