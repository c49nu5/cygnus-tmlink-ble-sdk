...
{
    public partial class BLEScannerViewModel : ObservableObject, IConnectionMonitor
    {
        private readonly ILogger<BLEScannerViewModel> _logger;
        ...
        public BLEScannerViewModel(
            ILogger<BLEScannerViewModel> logger,
            ...
            Func<GaugeViewModel> gaugeViewFactory)
        {
            ...
            ToggleScanning = new RelayCommand(ToggleScanForDevices);
